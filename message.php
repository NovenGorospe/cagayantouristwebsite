                                              ...
                                              while($row=mysqli_fetch_array($query)){
                                                ...
                                                <tr>
                                                  ...
                                                  <td><?php echo $row['email']; ?></td>
                                                   ...
                                                   <td>
                                                    <a href="#del<?php echo $row['contact_id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                                    <?php include('edit/messageButton.php')  ?>
                                                  </td>
                                                </tr>
                                                <?php
                                              }
