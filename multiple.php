                     ...
                     <div class="tab-pane fade in active" id="">
                       <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" style="width: 100%;">
                                        <li class="pull-right">
                                          <span><a href="add/dynamic.php" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add More Image</a></span>
                                        </li>
                                    </ul>
                                  </div>
                                 <div class="col-md-12">
                                              ...
                                              while($row=mysqli_fetch_array($query)){
                                                ...
                                                <tr>
                                                  ...
                                                  <td><?php echo $row['spot_id']; ?></td>
                                                   ...
                                                   <td>
                                                    <a href="#del<?php echo $row['image_id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                       ...
                                       <!--    <?php// include('add/add_multiple.php'); ?> -->
                                      </div>
                                </div>
                     </div>
