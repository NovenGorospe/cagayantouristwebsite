					      ...
					      <li class="dropdown">
					          ...
					          <ul class="dropdown-menu">
					            <?php
                                    ...
                                    //echo"<li><a href=spotCategory.php?y=".$row['type_id']."><option value='".$row['type_id']."'>".$row['type']."</option></a></li>";
                                      //}
                                      ?>  
		                              </ul>
							        </li>
     ...
     <div class="header">
		...
		<div class="content">
			<div class="promotions">
				<div class="container">
					...
					<h2 class="tittle">Different Events Of Cagayan</h2>
        ...
        <div class="container">
          ...
          <div class="contact-grids">
           <form method="POST" action="insert/insert_event.php">
