                     ...
                     <div class="tab-pane fade in active" id="">
                       <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" style="width: 100%;">
                                        <li class="pull-right">
                                         <span><a href="add/dynamicStory.php" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add More Story</a></span>
                                        </li>
                                    </ul>
                                  </div>
                                 <div class="col-md-12">
                                        <h4>Instructions Records:</h4>
                                        ...
                                        <div class="records_project" >
                                           ...
                                           <tbody>
                                            ...
                                            <?php
                                              ...
                                              $query = mysqli_query($dbconnect,"select * from story join spots on story.spot_id=spots.spot_id join types on types.type_id=spots.type_id");
                                                ...
                                                <tr>
                                                  ...
                                                  <td><?php echo $row['type']; ?></td>
                                                   <td><?php echo $row['spot']; ?></td>
                                                     <td><?php echo $row['first_story']; ?></td>
                                                       <td><?php echo $row['second_story']; ?></td>
                                                         <td><?php echo $row['third_story']; ?></td>
                                                           <td><?php echo $row['last_story']; ?></td>
                                                  
                                                  <td>
                                                         <?php 

                                                    echo "<a href=edit/edit_dynamicStory.php?y=".$row['story_id']."  class='btn btn-warning'><span class='glyphicon glyphicon-edit'></span> Edit</a>";
                                                     ?>
                                                  
                  
                                                  </td>
                                                   <td>
                                                    <a href="#del<?php echo $row['story_id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                                    <?php include('edit/edit_deleteStory.php')  ?>
                                                  </td>
                                                </tr>
                                                <?php
                                              }
