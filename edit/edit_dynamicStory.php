...
<body>
  ...
  include('config.php');
  $id = $_GET['y'];
  $sql = "select * from story where spot_id=".$id;
  $result = mysqli_query($dbconnect,$sql);
  
    ?>
  
                             <form method="POST" action="../update/add_story.php" enctype="multipart/form-data">
<?php 
 ...
 ?>
              ...
              <div style="height:10px;"></div>
               ...
               <div style="height:10px;"></div>
                ...
                <div class="col-lg-5">
                    <textarea class="form-control" name="first"><?php echo $row['first_story']; ?></textarea>
                </div>
              </div>
