        ...
        <div class="col-md-12">
                      ...
                      <div class="chart">
                       ...
                       <div style=" height:auto;" > 
                         <div class="tab-pane fade in active" id="">
                          <div class="header1">Add More Image</div>

                             <form method="POST" action="../insert/add_category.php"   enctype="multipart/form-data">
         ...
         <div class="col-lg-6">
             ...
             <div class="col-lg-3">
                           ...
                           <select  class="form-control" id="cat" name="cat"  placeholder="Type">
          ...
          <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                         <input multiple="" name="img[]" type="file" style="height: 20pt;"/>
                      </div>
              </div>
