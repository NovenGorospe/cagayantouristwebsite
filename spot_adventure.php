    ...
    <div class="content">
      <div class="promotions">
        <div class="container">
          <?php 
             $id=$_GET['y'];
                              $sql="SELECT * from category  where category.cat_id=".$id;
                              $result=mysqli_query($dbconnect,$sql);
                              while($row=mysqli_fetch_array($result)){

                              
           ?>
          <h2 class="tittle">----- <?php echo $row['category']; ?> -----</h2>
          <?php 
          } ?>
          <?php   include('config.php');?>
                              ...
                              <?php 
                               $id=$_GET['y'];
                              $sql="SELECT * from spot_category join category on spot_category.cat_id=category.cat_id join spots on spot_category.spot_id=spots.spot_id  where spot_category.cat_id=".$id;
                              $result=mysqli_query($dbconnect,$sql);
                              while($row=mysqli_fetch_array($result)){
                              $spot_id=$row['spot_id']
