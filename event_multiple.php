                     ...
                     <div class="tab-pane fade in active" id="">
                       <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" style="width: 100%;">
                                        <li class="pull-right">
                                          <span><a href="#moreImageSpot" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add More Image</a></span>
                                        </li>
                                    </ul>
                                  </div>
                                 <div class="col-md-12">
                                        <h4>Tourist Spots More Images:</h4>
                                        ...
                                        <div class="records_project" >
                                           ...
                                           <tbody>
                                            ...
                                            <?php
                                              include('config.php');
                                              $sql="SELECT * FROM `eventMultiple` JOIN events on eventMultiple.event_id=events.event_id";
                                               // join spots on multiple.spot_id=spots.spot_id join types on multiple.type_id=types.type_id
                                              $query=mysqli_query($dbconnect,$sql);
                                              while($row=mysqli_fetch_array($query)){
                                                ?>
                                                <tr>
                                                  <td><?php echo $row['eventmore_id']; ?></td>
                                                  ...
                                                  <td>
                                                   ...
                                                   <td>
                                                    <a href="#del<?php echo $row['eventmore_id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                      ...
                                      <?php include('add/add_moreEvent.php');?>
                                      </div>
                                </div>
                     </div>
