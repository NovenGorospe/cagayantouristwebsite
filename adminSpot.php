                       ...
                       <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" style="width: 100%;">
                                        ...
                                        <li class="pull-left">
                                            <?php 
                                                 $id=$_GET['y'];
                                                    echo "<a href=print_pdf2.php?y=".$id."  class='btn btn-warning'><span class='glyphicon glyphicon-edit'></span> Print</a>";
                                                     ?>
                                        ...
                                        <div class="records_project" >
                                           ...
                                           <tbody>
                                            ...
                                            <?php
                                              include('config.php');
                                               $id=$_GET['y'];
                                              $query = mysqli_query($dbconnect,"select * from spots join types on spots.type_id=types.type_id where spots.type_id=".$id);
