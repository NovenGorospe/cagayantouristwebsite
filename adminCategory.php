                     ...
                     <div class="tab-pane fade in active" id="">
                       <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" style="width: 100%;">
                                        <li class="pull-right">
                                         <span><a href="add/dynamicCategory.php" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add More Adventure</a></span>
                                        </li>
                                         <li class="pull-left">
                                            <?php 
                                                 $id=$_GET['y'];
                                                    echo "<a href=print_category.php?y=".$id."  class='btn btn-warning'><span class='glyphicon glyphicon-edit'></span> Print</a>";
                                                     ?>
                                                   </li>
                                        ...
                                        <div class="records_project" >
                                           ...
                                           <tbody>
                                            ...
                                            <?php
                                              include('config.php');
                                               $id=$_GET['y'];
                                              $query = mysqli_query($dbconnect,"select * from spot_category join category on spot_category.cat_id=category.cat_id join types on spot_category.type_id=types.type_id join spots on spot_category.spot_id=spots.spot_id where spot_category.cat_id=".$id);
                                              while($row=mysqli_fetch_array($query)){
                                                ?>
                                                <tr>
                                                  <td><?php echo $row['spot_cat_id']; ?></td>
                                                  ...
                                                  <td>
                                                    ...
                                                    echo "<a href=edit/edit_spot.php?y=".$row['spot_id']."  class='btn btn-warning'><span class='glyphicon glyphicon-edit'></span> Edit</a>";
                                                     ?>
