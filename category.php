                     ...
                     <div class="tab-pane fade in active" id="">
                       <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs" style="width: 100%;">
                                        <li class="pull-right">
                                          <span><a href="#add_cat" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add New Record</a></span>
                                        </li>
                                    </ul>
                                  </div>
                                 <div class="col-md-12">
                                        <h4>Adventures Records:</h4>
                                              ...
                                              while($row=mysqli_fetch_array($query)){
                                                ...
                                                <tr>
                                                  ...
                                                  <td><?php echo $row['category']; ?></td>
                                                   ...
                                                   <a href="#edit_cat<?php echo $row['cat_id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                                                   <?php include('edit/edit_cat_button.php'); ?>
                                                  
                                                  
                  
                                                  </td>
                                                   <td>
                                                    <a href="#del<?php echo $row['cat_id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                                    <?php include('edit/edit_cat_button.php')  ?>
                                                  </td>
                                                </tr>
                                                <?php
