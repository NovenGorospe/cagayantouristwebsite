				...
				<div class="container">
					...
					<?php   include('config.php');?>
                              ...
                              <?php 
                               ...
                               $spot=$_POST['search'];
                              $sql="SELECT * from spots WHERE spot like '%".$spot."%' OR location like'%".$spot."%'";
					...
					<div class="promotion-grids">
						...
						<div class="col-md-4 promation-grid">
							<?php 
							echo '<a href=spotView.php?y='.$row['spot_id'].'><img src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'" height="300" width="100%"></a>';
							 ?>
							<div class="prom-text">
